                ...
                <div class="monitor-navigation-header">
                    <ol class="header-nav">
                        <li v-show="item.show" class="header-nav-item"
                            ...
                            v-for="(item,index) in header.list" :key="item.id"
                            @click="handleSelect(index, item)"
                        >
                            {{item.name}}
                            <bk-popover
                                theme="light navigation-message" :arrow="false" offset="0, -5"
                                placement="bottom" :tippy-options="{ 'hideOnClick': false, flipBehavior: ['bottom'] }"
                            >
                                <router-link class="normal-link link-color box-normal-link" :to="item.url"></router-link>
                            </bk-popover>
                        </li>
                    </ol>
...
<script>
    import { bkNavigation, bkSelect, bkOption, bkPopover } from 'bk-magic-vue'
    export default {
