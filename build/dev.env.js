...
export default merge(prodEnv, {
    NODE_ENV: NODE_ENV,
    LOGIN_URL: JSON.stringify('http://appdev.gdpu.com:8080/login'),
    LOCAL_DEV_URL: JSON.stringify('http://appdev.gdpu.com'),
    LOCAL_DEV_PORT: JSON.stringify('8080'),
    AJAX_URL_PREFIX: JSON.stringify('http://appdev.gdpu.com:8000/api'),
    AJAX_MOCK_PARAM: JSON.stringify('mock-file'),
    USER_INFO_URL: JSON.stringify('user/v1/')
})
